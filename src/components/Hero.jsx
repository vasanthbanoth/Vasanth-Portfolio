        ...
        <section id="home" className="min-h-screen flex items-center justify-center pt-20">
            <div className="text-center relative z-10">
                ...
                >
                    ...
                    <img src="/images/user-profile.png" alt="Profile" className="relative w-32 h-32 md:w-40 md:h-40 rounded-full object-cover border-2 border-white/20 mx-auto bg-[#3f0d0c]" />
                </motion.div>
                ...
                >
                    <span className="bg-gradient-to-r from-white via-gray-300 to-gray-500 bg-clip-text text-transparent">AI &amp; SOFTWARE</span>
                    <br />
                    <span className="bg-gradient-to-r from-web3-primary to-web3-secondary bg-clip-text text-transparent">ENGINEER</span>
                </motion.h1>
